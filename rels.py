# Funcion RELS - Recursive Extended Least Squares
# Estimacion de gradientes de proceso usando expansion de Taylor de segundo grado, datos de proceso y el algoritmo RELS de identificación
# Entradas:
...
# alfa -> factor de olvido del RELS
import numpy as np
